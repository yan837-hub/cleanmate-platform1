...
CREATE TABLE `cleaner_profile`  (
  ...
  INDEX `fk_cleaner_profile_audited_by`(`audited_by` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '保洁员档期特殊调整表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cleaning_company`  (
  ...
  INDEX `fk_cleaning_company_audited_by`(`audited_by` ASC) USING BTREE,
  CONSTRAINT `fk_cleaning_company_audited_by` FOREIGN KEY (`audited_by`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '保洁公司表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `customer_address`  (
  ...
  CONSTRAINT `fk_customer_address_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1005 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '顾客地址表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `service_price_tier`  (
  ...
  CONSTRAINT `fk_price_tier_service_type` FOREIGN KEY (`service_type_id`) REFERENCES `service_type` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1005 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '面积阶梯定价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `service_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1005 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '服务类型表' ROW_FORMAT = Dynamic;
